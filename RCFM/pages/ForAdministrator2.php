...
<html lang="en">
    <head>
        ...
        <title>RC Fish Market - Dashboard</title>
...
#fishChart{
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a id="CashierDash" class="nav-link" href="#">Weight</a>
                                </nav>
                            </div>
                ...
                <main style="margin-top:-20px;">
                    ...
                    <div class="dashboardcont">
                        ...
                        <div class="dashthird">
                            ...
                            <div style="margin-left:50%; margin-top:-160px; width:25%;" class="totalrevenue">
                                <h3>SOLD PRODUCTS</h3>
                                <input style="width:90%; text-align:center;" type="text" value="<?php echo $product_count; ?>" readonly>
                            </div>

                            <div style="margin-top:-160px; width:49%;" class="totalrevenue">
                            ...
                            <div style="margin-left:76%;margin-top:-160px; width:23.5%;" class="totalrevenue">
                                <div style="margin-top:-20px;bacground-color:transparent;" id="piechart" style="width: 100%; height: 300px;"></div>
                            </div>
                    ...
                    <div class="dashthird">
                                <canvas id="fishChart" width="200px" height="120px"></canvas>
                            </div>
                </main>
            </div>
        </div>
    ...
    var fishChart = new Chart(ctx, {
        type: 'bar',
        data: {
            labels: ['Tuna', 'Mackerel', 'Sardines', 'Salmon', 'Cod', 'Premium', 'Standard'],
            datasets: [
                {
                    label: 'Tuna',
                    data: [<?php echo $tunaWeight;"kg" ?>],
                    backgroundColor: '#5A8E49',
                    borderColor: 'rgba(0, 0, 0, 1)',
                    borderWidth: 1
                },
                {
                    label: 'Mackerel',
                    data: [0, <?php echo $mackerelWeight;"kg" ?>],
                ...
                {
                    label: 'Sardines',
                    data: [0, 0, <?php echo $sardinesWeight; ?>],
                    backgroundColor: '#9B301C',
                    borderColor: 'rgba(0, 0, 0, 1)',
                    borderWidth: 1
                },
                {
                    label: 'Salmon',
                    data: [0, 0, 0, <?php echo $salmonWeight; ?>],
                    backgroundColor: '#E59D73',
                    borderColor: 'rgba(0, 0, 0, 1)',
                    borderWidth: 1
                },
                {
                    label: 'Cod',
                    data: [0, 0, 0, 0, <?php echo $codWeight; ?>],
                ...
                {
                    label: 'Premium',
                    data: [0, 0, 0, 0, 0, <?php echo $premiumWeight; ?>],
                ...
                {
                    label: 'Standard',
                    data: [0, 0, 0, 0, 0, 0, <?php echo $standardWeight; ?>],
